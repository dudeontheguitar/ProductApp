        ...
        CoroutineScope(Dispatchers.IO).launch {
            if (productDao.getAllProductsOnce().isEmpty()) { // Проверяем, есть ли уже товары
                val products = listOf(
                    ...
                    ProductEntity(2, "Carrots",29.50, "https://media.istockphoto.com/id/1388403435/photo/fresh-carrots-isolated-on-white-background.jpg?s=2048x2048&w=is&k=20&c=9sTXjB11hCYhq6VQVltZu3_QyHlygKVIbwi3iPVBhZw=", 0),
                    ProductEntity(3, "Bread", 39.50, "https://cdn.pixabay.com/photo/2018/06/10/20/30/bread-3467243_960_720.jpg", 0),
                    ProductEntity(4, "Honey", 49.40,"https://cdn.pixabay.com/photo/2020/04/14/18/13/honey-5043708_1280.jpg",  0),
                    ProductEntity(5, "Ice Cream",59.30, "https://cdn.pixabay.com/photo/2017/11/30/08/56/ice-cream-2987955_1280.jpg",  0),
                    ProductEntity(6, "Eggs", 69.60,"https://cdn.pixabay.com/photo/2016/05/05/15/29/eggs-1374141_960_720.jpg",  0),
